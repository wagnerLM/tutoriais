...
* Paralelismo, tau-equivalência e testes congenéricos
  * Para entender esses conceitos, vamos utilizar o diagrama representando o [Modelo linear de Spearman](https://en.wikipedia.org/wiki/Congeneric_reliability)
...
* Esses pressupostos restritivos do *__alpha de Cronbach__* levaram o Editor da revista do European Journal of Psychological Assessment a incentivar o uso de medidas alternativas de fidedignidade em submissões, em [editorial publicado](https://econtent.hogrefe.com/doi/10.1027/1015-5759/a000069)
...
* A seguir serão apresentadas formas de calcular o índice *McDonald's Omega* (*__ω__*) com métodos confirmatórios e exploratórios:
...
```
ininstall.packages("lavaan")
ininstall.packages("semTools")
ininstall.packages("psych")
```
